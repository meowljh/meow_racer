...
FNAME="STATEDEP_OSCI_NEWPEN3_JWbaseline_0316_3_5_15"
...
python tutorial_train.py \
    ...
    --use_jw 1 \
    --use_sde 0 \
    --do_reverse $REVERSE_PERCENT \
    --use_theta_diff 0 \
    --weight_save_converge 1 \
    --weight_save_interval 5 \
    --num_vecs $NUM_FORWARD_VEC \
    --theta_diff $FORWARD_VEC_THETA_DIFF \
    --lidar_deg $LIDAR_DEG \
    --both_track_ratio 0.1 \
    --skip_rate 1 \
    --max_episodes 10000 \
    --max_reward_tile $MAX_REWARD \
    ...
    --screen_title $FNAME \
    --save $FNAME \
    --terminate_penalty $TERMINATE_PENALTY