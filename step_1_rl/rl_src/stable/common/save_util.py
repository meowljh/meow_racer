...
from stable.common.type_aliases import TensorDict
from stable.common.utils import get_device, get_system_info
...
def save_to_zip_file(
    ...
    with zipfile.ZipFile(file, mode="w") as archive:
        ...
        archive.writestr("_stable_baselines3_version", stable.__version__)
