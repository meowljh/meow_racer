...
from stable.common.buffers import DictRolloutBuffer, RolloutBuffer
from stable.common.callbacks import BaseCallback
from stable.common.policies import ActorCriticPolicy
from stable.common.type_aliases import GymEnv, MaybeCallback, Schedule
from stable.common.utils import obs_as_tensor, safe_mean
...
class OnPolicyAlgorithm(BaseAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        self.policy = self.policy_class(  # type: ignore[assignment]
            self.observation_space, self.action_space, self.lr_schedule, use_sde=self.use_sde, 
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            if isinstance(self.action_space, spaces.Box):
                ...
                elif not self.policy.use_beta_dist:
                # else:
            ...
            ## 여기서 environment안에서 clipped action을 modify한 다음에 buffer에 넣으면 log_prob를 계산할때 오류가 있음
            ## 왜냐면 beta distribution은 0~1사이의 값만을 취급하기 떄문
