...
from stable.common.distributions import (
    BetaDistribution,
...
from stable.common.preprocessing import get_action_dim, is_image_space, maybe_transpose, preprocess_obs
...
from stable.common.utils import get_device, is_vectorized_observation, obs_as_tensor
...
class ActorCriticPolicy(BasePolicy):
    ...
    def __init__(
        ...
        if net_arch is None:
            if features_extractor_class == NatureCNN:
                ...
                ##pi: actor (learns the policy)
                ##vf: critic (learns the value function)
    ...
    def _get_action_dist_from_latent(self, latent_pi: th.Tensor) -> Distribution:
        ...
        """
        #### added probability distribution generation for BetaDistribution ####
        if isinstance(self.action_dist, BetaDistribution):
            alpha = self.alpha_net(latent_pi)
