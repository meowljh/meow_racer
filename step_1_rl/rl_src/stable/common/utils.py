...
from stable.common.logger import Logger, configure
from stable.common.type_aliases import GymEnv, Schedule, TensorDict, TrainFreq, TrainFrequencyUnit
...
def get_system_info(print_info: bool = True) -> tuple[dict[str, str], str]:
    ...
    env_info = {
        ...
        "Stable-Baselines3": stable.__version__,
