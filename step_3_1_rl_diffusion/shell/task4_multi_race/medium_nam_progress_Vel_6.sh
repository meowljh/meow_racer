...
STYLE_DEFENSIVE_WEIGHT=0.2 #0.3 #0.2 #0.1 #0.5 #1. #0.1 # #0.5 #0.4 #0.25 #0.5 #1. #0.8 #0.5
STYLE_AGGRESSIVE_WEIGHT=1. #0.5 #1. #0.1 # #0.5  #0.3 #0.25 #0.5  #0.5 #0.2 #0.5
...
E_PHI_REWARD_VALUE=0.1 #0.3 #0.2 #0.1 #0.5 # #1. #0.1
...
#experiment
EXP_NAME=0613_SingleFeet_DTx50_NAM_MEDIUM_Act3_Center_timePen_minVPen_offCnt_VelReward_ProgressReward1000_Weighted_6_Ephi01_LargeAggWeight_Def02
