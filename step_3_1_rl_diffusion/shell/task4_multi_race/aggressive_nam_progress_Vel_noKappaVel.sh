...
CURV_WEIGHTED_REWARD_WEIGHT=5. #1.
CURV_WEIGHTED_NORM=true

USE_KAPPA_VEL_REWARD=false #true
KAPPA_VEL_TARGET_THETA=20
KAPPA_VEL_REWARD_VALUE=1 #3 #1
...
EXP_NAME=0603_SingleFeet_DTx50_NAM_Aggressive_Act3_timePen01_minVPen_offCnt_NegVelAPSReward_PrgReward1000_PrgRewardVel1_NoKappa_Ephi01_KappaWeightVelReward
