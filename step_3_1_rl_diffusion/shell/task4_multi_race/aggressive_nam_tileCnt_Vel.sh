...
TILE_STEP_MAX_REWARD_WEIGHT=5000 #10000 #5000 #20000 #500
...
CURV_WEIGHTED_REWARD_WEIGHT=3. #1 #5. #1.
...
EXP_NAME=0603_SingleFeet_DTx50_NAM_Aggressive_Act3_timePen01_minVPen_offCnt_NegVelAPSReward_TileCntReward5000_PrgRewardVel1_KappaV1_Ephi01_KappaWeightVelReward3
