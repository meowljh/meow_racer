...
#style
STYLE_TYPE=medium
STYLE_COMMON_WEIGHT=1.5 #1. #0.5 #1. #0.5 #1.
STYLE_DEFENSIVE_WEIGHT=0.5 #1. #0.5 #0.25 #0.5 #1. #0.8 #0.5
STYLE_AGGRESSIVE_WEIGHT=1. #0.5 #1. #0.5 #0.25 #0.5  #0.5 #0.2 #0.5
...
#experiment
EXP_NAME=0612_SingleFeet_DTx50_NAM_MEDIUM_Act3_Center_timePen_minVPen_offCnt_VelReward_ProgressReward1000_Weighted_4_SmallEphi_LargeCommon
