...
PENALTY_CONDITION=off_course_count #차량의 바퀴가 나간 개수에 맞춰서 off-course penalty 부여

MAX_PATH_LENGTH=10000000000


python train_main.py \
    agent.exp_name=0514_Both_Act2_Center_targetVel_cntPen_sameTime \
