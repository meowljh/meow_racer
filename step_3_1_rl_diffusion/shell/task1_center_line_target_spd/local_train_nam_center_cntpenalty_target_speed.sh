...
python train_main.py \
    agent.exp_name=0514_NAM_Act3_Center_targetVel_SingleFeet_PenCnt_ThetaReward \
    ...
    penalty.min_velocity_penalty.penalty_value=$MIN_VEL_PENALTY_VALUE\
    ...
    reward.progress_reward_curve.usage=$USE_THETA_REWARD \
    reward.progress_reward_curve.reward_weight=$THETA_WEIGHT \
