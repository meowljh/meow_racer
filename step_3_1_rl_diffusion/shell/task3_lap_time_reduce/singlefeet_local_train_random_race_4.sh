...
USE_PROGRESS_REWARD_CURVE=false #true #false #true
PROGRESS_REWARD_CURVE_VALUE=20
...
EXP_NAME=0526_SingleFeet_Both_Act3_RACE_timePen01_minVPen_offCnt_NegVelAPSReward_PrgRewardVel1_PrgRewardCurv20_KappaV1_Ephi01
