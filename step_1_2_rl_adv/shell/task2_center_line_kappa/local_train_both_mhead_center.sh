...
python train_main.py --config-name config_mhead \
    agent.exp_name=local_debug_v4_Both_Act3_MHead \
    ...
    reward.center_line_reward.usage=true \
    reward.center_line_reward.e_phi_weight=1. \
    reward.center_line_reward.e_c_weight=1. \
