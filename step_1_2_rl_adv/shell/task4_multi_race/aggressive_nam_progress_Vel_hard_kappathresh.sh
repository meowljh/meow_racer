...
PROGRESS_REWARD_VALUE=1000 #1000 #500 #2000 # 100 #20 #5

# USE_VEL_JOINT_REWARD=false #true
# VEL_JOINT_CORNER_WEIGHT=3. #10. #3.
# VEL_JOINT_STRAIGHT_WEIGHT=1. #0.5
# VEL_JOINT_NORM_VEL=true # false
# VEL_JOINT_NORM_KAPPA=false #true
# VEL_JOINT_TRACK_ALIGN=true
# VEL_JOINT_KAPPA_THRESH=0.01 #0.005

USE_HARD_CORNER_VEL_REWARD=false #true
HARD_CORNER_VEL_REWARD_WEIGHT=1. #0.1 #0.05 #0.1 #0.5 #1. #5. #2. #1. #2. #0.5 #1
HARD_CORNER_KAPPA_NORM=true
HARD_CORNER_KAPPA_THRESH=0.01 #0.005
HARD_CORNER_VEL_NORM=true
HARD_CORNER_KAPPA_TO_PERCENT=true

USE_STRAIGHT_LINE_VEL_REWARD=true
STRAIGHT_LINE_VEL_REWARD_VALUE=3. #1. #1 #0.5
NORM_STRAIGHT_LINE_VEL=true
STRAIGHT_LINE_KAPPA_THRESH=0.01

USE_VELOCITY_REWARD=true
VELOCITY_REWARD_VALUE=1. #2. #3. #5. #3. #1 #10
NORM_VELOCITY_REWARD=true

USE_KAPPA_VEL_REWARD=true
KAPPA_VEL_TARGET_THETA=20
KAPPA_VEL_REWARD_VALUE=1. #3. #1. #3. #4. #3. #1. #3. #5. #3. #1. #2. #3 #1 #5 #1 #3 #1
...
CURV_WEIGHTED_KAPPA_WEIGHT=5 #1 #2 #5 #10 #1 #5 #10 # 1.
CURV_WEIGHTED_REWARD_WEIGHT=3. #1. #5. #3. #1.
...
EXP_NAME=0609_SingleFeet_DTx50_NAM_Aggressive_Act3_timePen01_minVPen_offCnt_NegVelAPSReward_PrgReward1000_PrgRewardVel1_KappaV3_Ephi01_KVel1_Hard
...
python train_main.py \
    ...
    reward.straight_line_vel_reward.usage=$USE_STRAIGHT_LINE_VEL_REWARD \
    reward.straight_line_vel_reward.reward_weight=$STRAIGHT_LINE_VEL_REWARD_VALUE \
    reward.straight_line_vel_reward.normalize_vel=$NORM_STRAIGHT_LINE_VEL \
    reward.straight_line_vel_reward.corner_kappa_thresh=$STRAIGHT_LINE_KAPPA_THRESH \
    ...
    reward.hard_corner_curvature_weighted_vel_reward.normed_kappa_to_percent=$HARD_CORNER_KAPPA_TO_PERCENT \
