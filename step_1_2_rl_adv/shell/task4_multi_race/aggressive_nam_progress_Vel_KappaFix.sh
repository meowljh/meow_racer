...
EXP_NAME=0604_SingleFeet_DTx50_NAM_Aggressive_Act3_timePen01_minVPen_offCnt_NegVelAPSReward_PrgReward1000_PrgRewardVel1_KappaV1ERROR_Ephi01_KappaWeightVelReward3
...
python train_main.py \
    ...
    reward.curvature_vel_reward.fix_possible_error=$KAPPA_VEL_FIX_ERROR \
    reward.curvature_vel_reward.vehicle_speed_vx=$KAPPA_VEL_VX \
