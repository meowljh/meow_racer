...
STYLE_DEFENSIVE_WEIGHT=0.5 #1. #0.1 # #0.5 #0.4 #0.25 #0.5 #1. #0.8 #0.5
STYLE_AGGRESSIVE_WEIGHT=0.5 #1. #0.1 # #0.5  #0.3 #0.25 #0.5  #0.5 #0.2 #0.5
...
E_C_PENALTY_WEIGHT=5. #10. #3. #10. #3 #10
...
CURV_WEIGHTED_REWARD_WEIGHT=1.5 #3. #1.5 #3.
...
TERMINATE_VEL_PATIENCE=0.02


#experiment
EXP_NAME=0610_SingleFeet_DTx50_NAM_MEDIUM_Act3_Center_timePen_minVPen_offCnt_VelReward_ProgressReward1000_Weighted_2_PenTerm
