...
#style
STYLE_TYPE=medium
STYLE_COMMON_WEIGHT=1. #0.3 #0.5 #1. #0.5 #1.
STYLE_DEFENSIVE_WEIGHT=0.2 #0.1 #0.2 #0.1 #0.5 #1. #0.1 # #0.5 #0.4 #0.25 #0.5 #1. #0.8 #0.5
STYLE_AGGRESSIVE_WEIGHT=1.3 #0.8 #0.5 #1. #0.5 #1. #0.1 # #0.5  #0.3 #0.25 #0.5  #0.5 #0.2 #0.5
...
E_PHI_REWARD_VALUE=0.1 #0.5 # #1. #0.1
...
E_C_PENALTY_WEIGHT=10. #3. #1. #10. #5. #10. #3. #10. #3 #10
...
USE_KAPPA_VEL_PENALTY=true
KAPPA_VEL_PEN_VALUE=0.1 #1. #0.5 #1. #5. #1. #3. #5.
KAPPA_VEL_PEN_NORM_VEL=true
KAPPA_VEL_PEN_NORM_KAPPA=true
KAPPA_VEL_PEN_CLIP_VALUE=0.75
...
CURV_WEIGHTED_KAPPA_WEIGHT=5.
CURV_WEIGHTED_REWARD_WEIGHT=3. #1.5 #1.5 #3. #1.5 #3.
...
#terminate
TERMINATE_PENALTY=500 #true
PENALTY_CONDITION=off_course_count
TERMINATE_VEL_COND=count_time_neg_vel
TERMINATE_VEL_PATIENCE=0.02 #0.1 #0.02


#experiment
EXP_NAME=0614_SingleFeet_DTx50_NAM_MEDIUM_Act3_Center_timePen_minVPen_offCnt_VelReward_ProgressReward1000_Weighted_100213_5_Ephi01_LargeAggWeight_Def02
...
python train_main.py \
    ...
    style.defensive.curvature_velocity_penalty.normed_kappa_clip_value=$KAPPA_VEL_PEN_CLIP_VALUE \
