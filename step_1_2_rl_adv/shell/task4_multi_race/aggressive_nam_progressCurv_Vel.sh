...
USE_PROGRESS_REWARD=false #true
PROGRESS_REWARD_VALUE=200 #500 #2000 # 100 #20 #5

USE_PROGRESS_REWARD_CURVE=true #false
PROGRESS_REWARD_CURVE_VALUE=5000 #30 #50 #30 #10 #20
NORM_PROGRESS_REWARD_CURVE=true #false
 

USE_KAPPA_VEL_REWARD=true
KAPPA_VEL_TARGET_THETA=20
KAPPA_VEL_REWARD_VALUE=1 #5 #1 #2 #1
...
EXP_NAME=0603_SingleFeet_DTx50_NAM_Aggressive_Act3_timePen1_minVPen_offCnt_NegVelAPSReward_PrgRewardCrvNorm5000_KappaV1_Ephi01_KappaWeightVelReward3
...
python train_main.py \
    ...
    reward.progress_reward_curve.scale_progress=$NORM_PROGRESS_REWARD_CURVE \
