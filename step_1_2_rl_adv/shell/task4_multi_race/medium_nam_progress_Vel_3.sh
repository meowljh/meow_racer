...
STYLE_DEFENSIVE_WEIGHT=0.1 #0.5 #1. #0.1 # #0.5 #0.4 #0.25 #0.5 #1. #0.8 #0.5
...
#experiment
EXP_NAME=0612_SingleFeet_DTx50_NAM_MEDIUM_Act3_Center_timePen_minVPen_offCnt_VelReward_ProgressReward1000_Weighted_3_SmallEphi_LargeAggWeight
