...
PROGRESS_REWARD_VALUE=1000 #50 #1000 #100 #300 #30 #50 #30 #15
...
APS_SMOOTH_PEN_VALUE=0.1 #1
BPS_SMOOTH_PEN_VALUE=0.1 #1
STEER_SMOOTH_PEN_VALUE=0.1 #1

USE_KAPPA_VEL_REWARD=true
KAPPA_VEL_REWARD_VALUE=1 #5 #1
...
EXP_NAME=0606_SingleFeet_DTx50_NAM_Defensive_Act3_Center_timePen_minVPen_offCnt_VelReward_ProgressReward1000_Ec10_TermV02_SmoothControl
...
python train_main.py \
    ...
    penalty.smooth_control_penalty.usage=$USE_SMOOTH_CONTROL_PENALTY \
    penalty.smooth_control_penalty.aps_penalty_value=$APS_SMOOTH_PEN_VALUE \
    penalty.smooth_control_penalty.bps_penalty_value=$BPS_SMOOTH_PEN_VALUE \
    penalty.smooth_control_penalty.steer_penalty_value=$STEER_SMOOTH_PEN_VALUE \
